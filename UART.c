...
static uint16_t UART_TxLength[UART_GROUPS_NUMBER];
static uint16_t UART_TxCount[UART_GROUPS_NUMBER];
static const uint8_t* UART_TxBuffPtr[UART_GROUPS_NUMBER];

static uint16_t UART_RxLength[UART_GROUPS_NUMBER];
static uint16_t UART_RxCount[UART_GROUPS_NUMBER];
...
UART_ChkType UART_Tx (uint8_t groupID)
{
        ...
        UART_ChkType RetVar;
        const UART_ConfigType* CfgPtr;
        uint16_t Transmitted_Bytes,Remaining_Bytes;
...
{
    uint16_t Received_Bytes,Remaining_Bytes;
    UART_ChkType RetVar;
    const UART_ConfigType* CfgPtr;
